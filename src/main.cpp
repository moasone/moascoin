...
unsigned int nStakeTargetSpacing = 1 * 60 * 2; // DIFF: 2-minute block spacing
unsigned int BlockTime = 60;
int64 nChainStartTime = 1488672000;
...
const string strMessageMagic = "MoasCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MoasCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "http://www.coinsoda.org/coin=1010";
        CTransaction txNew;
        txNew.nTime = nChainStartTime;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(10005) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 37;
        ...
        assert(block.hashMerkleRoot == uint256("0xad9d6826e9b80440378e22b5bb4dabae4c9d059c3bf0da7050b5d8b69bb6bdbb"));
