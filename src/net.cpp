...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MoasCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
//     {"coinsoda.com", "seed1.coinsoda.com"},
};
...
unsigned int pnSeed[] =
{
0x5e267ad2, 0x62267ad2, 0x69267ad2, 0x6b267ad2,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MoasCoin is probably already running."), addrBind.ToString().c_str());
        else
